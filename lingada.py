...
class Lingada:
    def __init__(self, id=None, orden=None, colada=None, producto=None,piezas=None, nivel=None, estado=None, acero=None,diametro=None, fecha_stock=None,estiba_nombre=None,centro_origen=None, centro_destino=None,status=None, inicial_date_prg=None, finish_date_prg=None):
